      ...
      <div className="mt-20 flex flex-col gap-14 py-4 xl:flex-row xl:gap-11">
        <div className="mt-10 flex flex-col xl:w-[580px]">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between xl:flex-col xl:items-start xl:justify-normal">
            ...
            <div>
              <button className="mt-14 w-full border border-primary bg-secondary px-6 py-4 uppercase text-primary xl:hidden">
                JOIN WAITLIST NOW
              </button>
            </div>
          </div>
          ...
          <button className="mt-14 hidden w-full border border-primary bg-secondary px-6 py-4 uppercase text-primary xl:block">
            JOIN WAITLIST NOW
          </button>
        </div>
