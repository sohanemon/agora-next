...
const TopHero = () => {
    return (
        <section className="container flex flex-col items-center gap-14 p-4 xl:flex-row xl:items-start sm:gap-16 xl:gap-40">
            <div className="mt-10 max-w-[450px] flex flex-col items-center xl:ml-4 xl:items-start">
